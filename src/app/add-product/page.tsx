    ...
    <main className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-grow max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <input type="file" accept=".csv,.xlsx" onChange={handleImportProducts} className="mb-2 file:bg-primary-100 file:text-primary-700 file:rounded file:border-0 file:px-4 file:py-2 file:mr-4 file:cursor-pointer" />
